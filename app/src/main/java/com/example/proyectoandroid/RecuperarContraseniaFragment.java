    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.botonCambiarContrasenia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                autenticacionViewModel.actualizarPassword(username,email,password);
            }
        });

        autenticacionViewModel.estadoUsuarioContrasenia.observe(getViewLifecycleOwner(), new Observer<AutenticacionViewModel.EstadoDelCambioDePassword>() {
            @Override
            public void onChanged(AutenticacionViewModel.EstadoDelCambioDePassword estadoDelCambioDePassword) {
